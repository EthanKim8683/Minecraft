...
object_options="--std=c++17 -O2"
linker_options="$object_options -lm -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sFULL_ES3=1 -sEXPORT_ALL -sALLOW_MEMORY_GROWTH --preload-file $assets"
