...
Vec4& Vec4::operator+=(float v) { x += v, y += v, z += v, w += v; return *this; }
Vec4& Vec4::operator-=(float v) { x -= v, y -= v, z -= v, w -= v; return *this; }
Vec4& Vec4::operator*=(float v) { x *= v, y *= v, z *= v, w *= v; return *this; }
Vec4& Vec4::operator/=(float v) { x /= v, y /= v, z /= v, w /= v; return *this; }
...
Vec4 operator+(Vec4 a, float b) { a += b; return a; }
Vec4 operator-(Vec4 a, float b) { a -= b; return a; }
Vec4 operator*(Vec4 a, float b) { a *= b; return a; }
Vec4 operator/(Vec4 a, float b) { a /= b; return a; }
...
Vec4 Vec4::max(const Vec4& a, float b) {
...
Vec4 Vec4::min(const Vec4& a, float b) {
...
Vec4 Vec4::clamp(const Vec4& a, float b, float c) {
...
Vec4 Vec4::mix(const Vec4& a, const Vec4& b, float c) {
